...
works with all distributions:
        - download the libStreamDeckPlugin.tar.gz and unpack it in downloads.
        - If you want build the Plugin from source, you must go to your build folder.
        - now copy the libStreamDeckPlugin.so to "/usr/lib64/obs-plugins" (opensuse)
